...
def check_wildcard_certificate_usage(certificate):
    ...
    return f"Wildcard certificate detected for: {', '.join(wildcards)}" if wildcards else "No wildcard certificates found."
...
if __name__ == "__main__":
    ...
    for port in COMMON_PORTS:
        ...
        if cert_info is not None:
            ...
            print("\nSecurity Issues:")
            security_issues_table = [[issue] for issue in security_issues]
